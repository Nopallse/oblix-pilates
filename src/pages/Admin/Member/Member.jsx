    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage member profiles, memberships, and activities</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
          <div className="flex space-x-2">
            {['all', 'active', 'expired', 'suspended'].map((filterType) => (
              <button
                key={filterType}
              ...
              {filteredMembers.map((member) => (
                <tr key={member.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {member.remainingSessions === 999 ? 'Unlimited' : member.remainingSessions} remaining
                  </td>
